...
public class EventHandler implements LocationListener{
    ...
    private void checkEventsHandler(Location loc) {
        if(curLoc != loc) {
            curLoc = loc;
    ...
    public void checkEventsHandler(){
        checkEvents();
    }
